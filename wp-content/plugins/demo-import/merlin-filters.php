 ...
 */
function conexi_unset_default_widgets_args( $widget_areas ) {
...
add_filter( 'merlin_unset_default_widgets_args', 'conexi_unset_default_widgets_args' );
 ...
 */
function conexi_child_functions_php( $output, $slug ) {
...
add_filter( 'merlin_generate_child_functions_php', 'conexi_child_functions_php', 10, 2 );
 ...
 */
function conexi_local_import_files() {
	return array(
		array(
			'import_file_name'         => esc_html__('Main Demo', 'conexi'),
			...
			'import_notice'            => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'conexi' ),
			'preview_url'              => 'https://old3.commonsupport.com/conexi29/',
		),
	);
}

add_filter( 'merlin_import_files', 'conexi_local_import_files' );

/**
 * Execute custom code after the whole import has finished.
 */
function conexi_after_import_setup() {
...
add_action( 'merlin_after_all_import', 'conexi_after_import_setup' );
