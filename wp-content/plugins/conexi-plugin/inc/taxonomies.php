...
namespace CONEXIPLUGIN\Inc;


use CONEXIPLUGIN\Inc\Abstracts\Taxonomy;
...
class Taxonomies extends Taxonomy {
	...
	public static function init() {
		...
		register_taxonomy( 'project_cat', 'conexi_project', $args );
		...
		register_taxonomy( 'service_cat', 'conexi_service', $args );
		...
		register_taxonomy( 'testimonials_cat', 'conexi_testimonials', $args );
		...
		register_taxonomy( 'team_cat', 'conexi_team', $args );
		...
		register_taxonomy( 'faqs_cat', 'conexi_faqs', $args );
	}
