 ...
 * @since 1.0.0
 */
class Service_Img extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service Image', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_img',
			[
				'label' => esc_html__( 'Service Image', 'conexi' ),
			]
		);
	...
	protected function render() {
		...
		<section class="offer-style-one <?php echo $settings['sec_class'];?>">
            <div class="container">
                    ...
                    <div class="col-lg-<?php echo esc_attr($item['block_column'], true );?>">
                        <div class="single-offer-one hvr-float-shadow">
                            <div class="image-block">
                                <a href="<?php echo esc_url($item['block_btnlink']['url']);?>"><i class="fa fa-link"></i></a>
                                <img src="<?php echo esc_url($item['block_image']['url']);?>" alt="<?php esc_attr_e('Image', 'conexi'); ?>" />
                            </div><!-- /.image-block -->
                            <div class="text-block">
                                <h3><a href="<?php echo esc_url($item['block_btnlink1']['url']);?>"><?php echo wp_kses($item['block_title'], $allowed_tags);?></a></h3>
                                <p><?php echo wp_kses($item['block_text'], $allowed_tags);?></p>
                                <a href="<?php echo esc_url($item['block_btnlink2']['url']);?>" class="more-link"><?php echo wp_kses($item['block_button'], $allowed_tags);?></a>
                            </div><!-- /.text-block -->
