...
class Slider extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'slider',
			[
				'label' => esc_html__( 'Slider', 'conexi' ),
			]
		);
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <h3 class="banner-title"><?php echo wp_kses($item['block_title'], $allowed_tags);?></h3>
