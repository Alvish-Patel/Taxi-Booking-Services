 ...
 * @since 1.0.0
 */
class Taxi_Details extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Taxi Details', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'taxi_details',
			[
				'label' => esc_html__( 'Taxi Details', 'conexi' ),
			]
		);
	...
	protected function render() {
		...
		<section class="single-taxi-details-one <?php echo $settings['sec_class'];?>">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="content-block">
                            ...
                            <a href="<?php echo esc_url($settings['btnlink']['url']);?>" class="book-btn"><?php echo $settings['bttn'];?></a>
                        </div><!-- /.content-block -->
                    </div><!-- /.col-lg-6 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
