...
class History extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'History', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'history',
			[
				'label' => esc_html__( 'History', 'conexi' ),
			]
		);
...
?>
		...
		<section class="history-style-one <?php echo $settings['sec_class'];?>">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="content-block">
                            ...
                            <div class="history-content history-content-one-pager">
                                ...
                                <a href="<?php echo esc_url($item['block_btnlink']['url']);?>" class="pager-item <?php if($key == 1) echo 'active';?>" data-slide-index="1">
                                    <h3><?php echo wp_kses($item['block_number'], $allowed_tags);?></h3>
