 ...
 * @since 1.0.0
 */
class Book_Ride extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Book Ride', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'book_ride',
			[
				'label' => esc_html__( 'Book Ride', 'conexi' ),
			]
		);
	...
	protected function render() {
		...
		<section class="book-ride-two <?php echo $settings['sec_class'];?>">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
