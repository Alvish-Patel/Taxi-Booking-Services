...
class Faq extends Widget_Base {
	...
	protected function render() {
		...
		<section class="single-taxi-faq-one thm-gray-bg <?php echo $settings['sec_class'];?>">
            <div class="container">
