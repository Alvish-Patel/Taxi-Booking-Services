 ...
 * @since 1.0.0
 */
class H3_Clients extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H3 Clients', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'h3_clients',
			[
				'label' => esc_html__( 'H3 Clients', 'conexi' ),
			]
		);
		$this->add_control(
			'sec_class',
...
?>
        ...
        <div class="brand-carousel-wrapper <?php echo esc_attr($settings['sec_class']);?>">
            <div class="container">
