...
class H3_Pricing extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H3 Pricing', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'h3_pricing',
			[
				'label' => esc_html__( 'H3 Pricing', 'conexi' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	protected function render() {
        ...
        <section class="taxi-fares-three welcome-three container <?php echo esc_attr($settings['sec_class']);?>">
            ...
            <p class="text-center"><?php echo $settings['text'];?></p>
        </section>
