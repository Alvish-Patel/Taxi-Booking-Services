 ...
 * @since 1.0.0
 */
class H3_Blog extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'H3 Blog', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'h3_blog',
			[
				'label' => esc_html__( 'H3 Blog', 'conexi' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	protected function render() {
		...
		{ ?>
          ...
          <section class="news-three news-four container <?php echo esc_attr($settings['sec_class']);?>"> 
