 ...
 * @since 1.0.0
 */
class Blog_Right extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog Right', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'blog_right',
			[
				'label' => esc_html__( 'Blog Right', 'conexi' ),
			]
		);
	...
	protected function render() {
		...
		<section class="blog-style-one three <?php echo $settings['sec_class'];?>">
				<div class="container">
				<div class="row">
							...
							<div class="col-xl-12 col-lg-6">
								<div class="single-blog-style-two">
									...
									<div class="text-block">
										<a href="#" class="date-block"><?php echo get_the_date('d'); ?> <?php echo get_the_date('M'); ?><?php esc_html_e(',', 'rashid'); ?> <?php echo get_the_date('Y'); ?></a>
