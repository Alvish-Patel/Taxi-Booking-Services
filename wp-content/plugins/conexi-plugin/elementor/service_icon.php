...
class Service_Icon extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Service Icon', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'service_icon',
			[
				'label' => esc_html__( 'Service Icon', 'conexi' ),
			]
		);
	...
	protected function render() {
		...
		<section class="feature-style-one thm-black-bg <?php echo $settings['sec_class'];?>">
            <img src="<?php echo esc_url($settings['image']['url']);?>" alt="<?php esc_attr_e('Image', 'conexi'); ?>" class="feature-bg" />
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-<?php echo esc_attr($item['block_column'], true );?>">
                        <div class="single-feature-one">
                            ...
                            <a href="<?php echo esc_url($item['block_btnlink1']['url']);?>" class="more-link"><?php echo wp_kses($item['block_button'], $allowed_tags);?></a>
