...
class Slider2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider 2', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'slider2',
			[
				'label' => esc_html__( 'Slider 2', 'conexi' ),
			]
		);
		...
		$this->start_controls_section(
				'content_section',
				[
					'label' => __( 'Slider Content', 'rashid' ),
...
?>
		...
		<div class="main-banner-wrapper <?php echo $settings['sec_class'];?>">
            <section class="banner-style-two owl-theme owl-carousel no-dots">
			
				<?php foreach($settings['repeat'] as $item):?>
			
                <div class="slide slide-one" style="background-image: url(<?php echo esc_url($item['block_bgimg']['url']);?>);">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 text-center">
                                <div class="banner-circle" style="background-image: url(<?php echo esc_url($item['block_bgimg']['url']);?>);">
