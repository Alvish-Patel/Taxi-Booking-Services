...
class Funfact extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Funfact', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'funfact',
			[
				'label' => esc_html__( 'Funfact', 'conexi' ),
			]
		);
	...
	protected function render() {
		...
		<section class="funfact-style-one <?php echo $settings['sec_class'];?>">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-<?php echo esc_attr($item['block_column'], true );?> col-md-6 col-sm-12">
                        <div class="single-funfact-one hvr-float-shadow">
                            ...
                            <h3 class="counter"><?php echo esc_attr($item['ff_stop']);?></h3>
