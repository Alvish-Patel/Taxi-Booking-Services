 ...
 * @since 1.0.0
 */
class Similar_Taxis extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Similar Taxis', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'similar_taxis',
			[
				'label' => esc_html__( 'Similar Taxis', 'conexi' ),
			]
		);
