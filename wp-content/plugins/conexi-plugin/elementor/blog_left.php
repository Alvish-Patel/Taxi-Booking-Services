 ...
 * @since 1.0.0
 */
class Blog_Left extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog Left', 'conexi' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'blog_left',
			[
				'label' => esc_html__( 'Blog Left', 'conexi' ),
			]
		);
	...
	protected function render() {
		...
		<section class="blog-style-one two <?php echo $settings['sec_class'];?>">
			<div class="container">
				<div class="row">
