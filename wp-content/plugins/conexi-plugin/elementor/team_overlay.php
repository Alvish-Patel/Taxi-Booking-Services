...
class Team_Overlay extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Team Overlay', 'conexi' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'team_overlay',
			[
				'label' => esc_html__( 'Team Overlay', 'conexi' ),
			]
		);
		$this->add_control(
			'sec_class',
			  ...
			  <div class="image-inner">
                    ...
                    <?php endif;?>
					  ...
					  <div class="overlay">
					   ...
					   <a href="<?php echo esc_url($item['block_btnlink']['url']);?>"><i class="<?php echo str_replace("icon ", " ", esc_attr( $item['block_icons']['value']));?>"></i></a>    
                        <?php endforeach; ?>
                    </div>
